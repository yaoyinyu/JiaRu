...
| 文件 | 说明 |
|------|------|
| [dev-log/2025-06-21.md](dev-log/2025-06-21.md) | 项目初始化 |
| [dev-log/2025-06-22.md](dev-log/2025-06-22.md) | 首页交互 + AR 模块开发 |
| [dev-log/2025-06-23.md](dev-log/2025-06-23.md) | Phase 1 修复 + AR 手心/手背检测实现 |
| [dev-log/2025-06-24.md](dev-log/2025-06-24.md) | AR 摄像头管线重写 + 逐指指甲可见性检测 |
...
- 逐指指甲可见性检测（isNailVisible, TIP.z vs DIP.z）
