...
- `01138…_7`已完成五甲人工polygon、原分辨率整图与逐甲2×复核、几何5/5和零交叠，candidate9补强规范索引v31由60张/419 mask增至61张/424 mask，返修图由15降至14，摘要`c6fafa89…a6ea1`。`01130…_10`已识别出旧SAM漏掉上方透明延长甲、把一枚甲拆成两个重叠mask及多个只覆盖装饰/局部区域的问题；当前混合返修只保留为候选，未通过完整逐甲终审前不得计入真值。
