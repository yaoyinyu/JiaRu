...
candidate51已在任何模型或旧mask辅助前冻结5张/4来源组/预计40枚完整甲面的新源图，文件名清单SHA-256为`d1fe39422ca54deb12b435581a7beed433beaec2c21826e6091725b1135351a1`。旧候选审计只证明4张/31 polygon可作为返修入口：0非法、0越界、0贴边，但7对交叠、仅1张机器零交叠、3张机器返修，第5张没有完整旧候选；因此全部继续禁止训练，原分辨率逐甲终审和规范真值终结仍是强门。加速仅允许把非生产ONNX/Worker替换验证前置，不允许提前写生产manifest。当前重放读取497个标记、455个PASS，14门仍为4通过/10失败，正确保持HOLD。
