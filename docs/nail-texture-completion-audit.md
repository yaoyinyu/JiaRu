...
candidate51已在任何模型或旧mask辅助前冻结5张/4来源组新源图；`00624`原图复核剔除旧重复/皮肤误标并拆分相邻甲后，全批实为38枚完整甲面。文件名清单SHA-256仍为`d1fe39422ca54deb12b435581a7beed433beaec2c21826e6091725b1135351a1`，修正后的源冻结文件SHA-256为`025655c9f31bb04259b1d0b87ebe2a239d5d87195242b85d60d3f536a9d93a2e`。`00710/00225`已通过原分辨率整图/逐甲终审、polygon合法性与零交叠门，重新绑定后仍为2张/9 mask真值候选；与candidate50基线合并的中间索引v2为323张/1944 mask/107来源组，索引SHA-256 `2b17925685c2ba2e8735292b8f802dd3b5b1c1ae87ff83557da27093bff438d2`、规范条目SHA-256 `33580c22e4a21bbb839335fe68e596954015a2eed98cca8034e453064e7ca993`，零冲突/冗余。`00624`当前9 polygon虽机器合法且零交叠，但逐甲放大仍发现透明延长甲和装饰外缘边界风险，保持返修且不计PASS；`00624/00625/00846`剩余3张/29 mask终审、整批物化与candidate51直接训练仍是强门。OpenAI `gpt-image-2`没有本地可微蒸馏运行、软信号或学生权重证据，candidate16本地蒸馏已被val30否决；加速仅允许单一直接候选与非生产ONNX/Worker验证前置，不允许提前写生产manifest。最新机器重放为498标记/456 PASS、14门4通过/10失败，`ok=false`、`decision=hold`，报告SHA-256 `0864213438603f6d9997863e773ccd2fd18e0729ed284d409bfa48e21c393035`。产品继续HOLD。
