...
| `M2-T3-RECOGNITION-POSITIVE-MASK-REVIEW-036` | candidate6正样本完整甲面mask候选与原分辨率审核 | 🟡 IN PROGRESS | 8分片/80页、160/160张首轮原分辨率审核为13 pass、147 rework、0 exclude。首批返修终审4张/15 mask通过；第二批逐甲紧框仅1张/5 mask通过，两张透明低对比甲经人工多边形新增10 mask；后续25张原分辨率人工/混合polygon新增114枚完整甲面，全部合法、零交叠、几何114/114，并通过整图与逐甲2倍终审及深度真值审计。batch022的重复身份返修仍不计数；batch023—036完成花纹/透明、裸粉长甲、侧视透明拇指、手链误检删除、失焦候选止损、附着钻饰、遮挡补回及交叠止损。batch037先拒绝被大面积遮挡、需猜测隐藏边界的`nail_01161…_0.jpg`，改选同来源组五甲完整清晰的`nail_01163…_2.jpg`；删除3个重复、整指或皮肤污染候选，保留4个完整mask并以人工polygon替换无效拓扑豹纹甲。终版5/5合法、零交叠、几何5/5，整图及逐甲2倍确认无皮肤、毛衣、背景、水印、重复或无效拓扑污染。权威与重放现为52张/225 mask、0拒绝/冗余/冲突、SHA-256 `487976b7…4b10`。正样本水印仅在遮挡/触碰甲面或损害清晰完整性时排除；困难负样本水印消融门不变。其余108张尚未形成最终真值，完整训练物化仍未完成，索引继续`trainingUse=prohibited-until-materialization-audit` |
