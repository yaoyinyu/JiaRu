...
| `M2-T3-RECOGNITION-POSITIVE-MASK-REVIEW-044` | candidate6正样本完整甲面mask候选与原分辨率审核 | 🟡 IN PROGRESS | 8分片/80页、160/160张首轮原分辨率审核为13 pass、147 rework、0 exclude。首批返修终审4张/15 mask通过；第二批逐甲紧框仅1张/5 mask通过，两张透明低对比甲经人工多边形新增10 mask；后续27张原分辨率人工/混合polygon新增124枚完整甲面，全部合法、零交叠、几何124/124，并通过整图与逐甲2倍终审及深度真值审计。batch022的重复身份返修仍不计数；batch023—043完成多类花纹/透明长甲、侧视透明拇指、失焦止损、附着钻饰、遮挡补回、无效拓扑替换、整指/手链误标清退以及法式/彩色长甲返修。batch044完成双手十甲戒指假阳性与皮肤尾巴清退。batch045选择单手五枚透明/金属/立体饰件甲完整清晰的`nail_00730…_1.jpg`；旧6/5候选存在同甲重复和交叠，首轮删重复后仍因三枚甲根皮肤尖尾及透明拇指指腹污染被逐甲2倍门拒绝。终版仅保留顶部金色饰件甲旧polygon并人工重画其余四甲，5/5合法、零交叠、几何5/5；整图和五组逐甲2倍确认完整甲根、侧缘、甲尖与甲板内饰件，无皮肤、邻指、戒指、衣物、背景、文字、水印、重复或交叠污染。错误truth路径和非规范终结文件名版本均隔离且不计数。权威与重放现为60张/275 mask、0拒绝/冗余/冲突、SHA-256 `cb5ca372…f340`。正样本水印门及困难负样本水印消融门不变。其余100张尚未形成最终真值，完整训练物化仍未完成，索引继续`trainingUse=prohibited-until-materialization-audit` |
