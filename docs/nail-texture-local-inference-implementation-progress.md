...
| `REL-T2-CANDIDATE` | 正式模型候选发布 | 🔴 HOLD（candidate5已拒绝，candidate6数据10/160） | 第二候选因独立留出7/5/6张误检被否决，第三候选因规范val30联合门失败被否决，第四候选因新独立留出3/2/3张误检被否决；candidate5虽过规范val30和冻结test100，仍在另一批训练后新100张独立留出上产生3/4/3张误检、5/4/6个检测及1/1 delta，零误检/零delta门失败。candidate6仅完成训练负样本计划和首族10张生成机器门，尚缺150张、正式终审与精确授权。生产manifest、共享阈值和正式ONNX保持不变；candidate6训练后仍须再建另一份全新未见留出 |
