...
| `M2-T3-RECOGNITION-POSITIVE-MASK-REVIEW-014` | candidate6正样本完整甲面mask候选与原分辨率审核 | 🟡 IN PROGRESS | 8分片/80页、160/160张首轮原分辨率审核为13 pass、147 rework、0 exclude。首批返修终审4张/15 mask通过；第二批逐甲紧框仅1张/5 mask通过，两张透明低对比甲经人工多边形新增10 mask；后续9张原分辨率人工polygon新增44枚完整甲面，全部合法、零交叠、几何44/44，并通过整图与逐甲2倍终审及深度真值审计。`nail_00521…_1.jpg`因初审第5区域实际为白手套背景而保持rework、未晋级。累计29张/120 mask，唯一索引`9fb08122…12a4`为0拒绝/冗余/冲突；其余131张尚未形成最终真值，完整训练物化仍未完成，索引继续`trainingUse=prohibited-until-materialization-audit` |
