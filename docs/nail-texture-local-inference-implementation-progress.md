...
| `M2-T3-RECOGNITION-POSITIVE-MASK-REVIEW-035` | candidate6正样本完整甲面mask候选与原分辨率审核 | 🟡 IN PROGRESS | 8分片/80页、160/160张首轮原分辨率审核为13 pass、147 rework、0 exclude。首批返修终审4张/15 mask通过；第二批逐甲紧框仅1张/5 mask通过，两张透明低对比甲经人工多边形新增10 mask；后续24张原分辨率人工/混合polygon新增109枚完整甲面，全部合法、零交叠、几何109/109，并通过整图与逐甲2倍终审及深度真值审计。batch022的重复身份返修仍不计数；batch023—035完成花纹/透明、裸粉长甲、侧视透明拇指、手链误检删除、失焦候选止损、附着钻饰及交叠止损。batch036对`nail_00774…_0.jpg`保留三枚已审甲面并补回被前景蝴蝶装饰甲部分遮挡的粉色长甲；首版交叠被构建器拒绝，按真实遮挡边界形成缺口后4/4合法、零交叠、几何4/4，整图和逐甲2倍确认甲面及附着装饰完整且无皮肤、衣物、背景、水印或重复污染。权威与重放现为51张/220 mask、0拒绝/冗余/冲突、SHA-256 `34cb56c9…9714`。正样本水印仅在遮挡/触碰甲面或损害清晰完整性时排除；困难负样本水印消融门不变。其余109张尚未形成最终真值，完整训练物化仍未完成，索引继续`trainingUse=prohibited-until-materialization-audit` |
