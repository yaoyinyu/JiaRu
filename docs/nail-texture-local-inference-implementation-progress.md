...
| `M2-T3-RECOGNITION-POSITIVE-MASK-REVIEW-040` | candidate6正样本完整甲面mask候选与原分辨率审核 | 🟡 IN PROGRESS | 8分片/80页、160/160张首轮原分辨率审核为13 pass、147 rework、0 exclude。首批返修终审4张/15 mask通过；第二批逐甲紧框仅1张/5 mask通过，两张透明低对比甲经人工多边形新增10 mask；后续27张原分辨率人工/混合polygon新增124枚完整甲面，全部合法、零交叠、几何124/124，并通过整图与逐甲2倍终审及深度真值审计。batch022的重复身份返修仍不计数；batch023—040完成多类花纹/透明长甲、侧视透明拇指、失焦止损、附着钻饰、遮挡补回、无效拓扑替换、整指/手链误标清退和法式长甲返修。batch041选择来源组未占用且五枚彩色/透明长甲完整清晰的`nail_00251…_7.jpg`，保留原第1—5甲面候选，删除第6、7手指/背景误标。终版5/5合法、零交叠、几何5/5，整图及逐甲2倍确认完整甲根、两侧甲缘、透明/彩色甲尖和星形立体装饰，无皮肤、戒指、衣袖、地板背景、文字、水印、重复或交叠污染。权威与重放现为56张/245 mask、0拒绝/冗余/冲突、SHA-256 `11869cd6…066e`。正样本水印门及困难负样本水印消融门不变。其余104张尚未形成最终真值，完整训练物化仍未完成，索引继续`trainingUse=prohibited-until-materialization-audit` |
