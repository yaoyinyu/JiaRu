...
| `M2-T3-RECOGNITION-POSITIVE-MASK-REVIEW-034` | candidate6正样本完整甲面mask候选与原分辨率审核 | 🟡 IN PROGRESS | 8分片/80页、160/160张首轮原分辨率审核为13 pass、147 rework、0 exclude。首批返修终审4张/15 mask通过；第二批逐甲紧框仅1张/5 mask通过，两张透明低对比甲经人工多边形新增10 mask；后续23张原分辨率人工/混合polygon新增105枚完整甲面，全部合法、零交叠、几何105/105，并通过整图与逐甲2倍终审及深度真值审计。batch022的重复身份返修仍不计数；batch023—033完成花纹/透明、裸粉长甲、侧视透明拇指、手链误检删除、失焦候选止损、附着钻饰及交叠止损。batch034完成远景人像五甲全人工返修；batch035对`nail_00546…_3.jpg`删除吞入大面积皮肤的重复拇指候选，保留并终审五枚透明水钻甲，5/5合法、零交叠、几何5/5，整图和逐甲2倍确认完整且无皮肤、戒指、衣物、背景、水印或重复污染。权威与重放现为50张/216 mask、0拒绝/冗余/冲突、SHA-256 `33017281…ce8c`。正样本水印仅在遮挡/触碰甲面或损害清晰完整性时排除；困难负样本水印消融门不变。其余110张尚未形成最终真值，完整训练物化仍未完成，索引继续`trainingUse=prohibited-until-materialization-audit` |
