...
| `M2-T3-RECOGNITION-POSITIVE-MASK-REVIEW-026` | candidate6正样本完整甲面mask候选与原分辨率审核 | 🟡 IN PROGRESS | 8分片/80页、160/160张首轮原分辨率审核为13 pass、147 rework、0 exclude。首批返修终审4张/15 mask通过；第二批逐甲紧框仅1张/5 mask通过，两张透明低对比甲经人工多边形新增10 mask；后续20张原分辨率人工/混合polygon新增90枚完整甲面，全部合法、零交叠、几何90/90，并通过整图与逐甲2倍终审及深度真值审计。batch022的重复身份返修仍不计数；batch023—025处理花纹/透明、裸粉长甲及侧视透明拇指。batch026删除手链珠子误检并补齐漏甲；batch027对`nail_00572…_7.jpg`保留2枚完整旧polygon，重建横向透明长甲、左缘凹口长甲及漏标侧视透明拇指，首版非甲面污染/漏装饰均被视觉门拦截，终版5/5合法、零交叠、几何5/5并通过整图与逐甲2倍终审。权威与重放现为42张/176 mask、0拒绝/冗余/冲突、SHA-256 `85a564c9…a51a`。正样本水印仅在遮挡/触碰甲面或损害清晰完整性时排除；困难负样本水印消融门不变。其余118张尚未形成最终真值，完整训练物化仍未完成，索引继续`trainingUse=prohibited-until-materialization-audit` |
