...
| `M2-T3-RECOGNITION-POSITIVE-MASK-REVIEW-049` | candidate6正样本完整甲面mask候选与原分辨率审核 | 🟡 IN PROGRESS | 8分片/80页、160/160张首轮原分辨率审核为13 pass、147 rework、0 exclude。首批返修终审4张/15 mask通过；第二批逐甲紧框仅1张/5 mask通过，两张透明低对比甲经人工多边形新增10 mask；后续29张原分辨率人工/混合polygon新增139枚完整甲面，全部合法、零交叠、几何139/139，并通过整图与逐甲2倍终审及深度真值审计。batch022的重复身份返修仍不计数；batch023—043完成多类花纹/透明长甲、侧视透明拇指、失焦止损、附着钻饰、遮挡补回、无效拓扑替换、整指/手链误标清退以及法式/彩色长甲返修。batch044—050完成双手十甲戒指/重复/整指误标清退、透明/金属/立体饰件边界返修、透明交叉甲止损、单手长杏仁甲与透明金尖甲清理，以及精确授权清单回归。batch051逐图拒绝甲数不符、裁边、遮挡、低清、镜面重复和侧视边界不可确认项，选择授权预期与原图一致的近景双甲`nail_01012…_6.jpg`；顶部水印与甲面/mask空间分离。原8个SAM候选均为蝴蝶结、金线、文字或局部甲面误分，全部删除并沿可见平滑甲板外缘人工重画2枚完整polygon；2/2合法、零交叠、几何2/2，整图及逐甲2倍确认完整甲根、侧缘、甲尖和甲板内装饰，无皮肤、邻指、背景、文字、重复或交叠污染。权威与本批重放现为65张/307 mask、0拒绝/冗余/冲突、SHA-256 `5c26caad…aef0`。困难负样本水印消融门不变。其余95张尚未形成最终真值，完整训练物化仍未完成，索引继续`trainingUse=prohibited-until-materialization-audit` |
