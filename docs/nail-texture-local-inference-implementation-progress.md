...
| `M2-T3-CANDIDATE49-TRAINING-001` | 足量新增完整边界真值后的直接学生训练 | 🟠 等待足量新真值 | 当前有效增量仅1张/10 mask，不以低收益GPU迭代冒充模型进展。继续收集来源隔离的透明低对比、饰品干扰、双手密集和相邻甲面真值；不得复用candidate48拒绝权重或读取test100。 |
