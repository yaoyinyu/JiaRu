...
| 模型发布治理 | `scripts/*release*` | 进行中 | 已有注册、切换、回滚、质量门、逐图失败画像、val专用阈值校准、最终完成度审计和外部验收证据构建器；2026-07-20刷新审计为326个进度标记/314个PASS、2/10发布门通过并输出HOLD。该2/10衡量完整发布闭环，不代表候选训练仅完成20% |
