...
| 候选5训练负样本 | `build-candidate5-hard-negative-generation-plan.py`、Git外`2026_7_29_candidate5_training_v2` | 进行中（130/160，训练禁止） | candidate4留出已由registry v2保护；160项失败类型计划固定。鱼饵001—030、家具五金031—060、发夹061—090、凸面宝石091—100、金属镶座101—110、手工五金111—120及非美甲化妆工具121—130已逐图生成、完成生成阶段可见初筛和增量机器审计，130通过、0失败、0未知，最新报告`d6cc9cb2…5269`。尚缺30张；生成通过不等于训练批准，全批未获商业训练精确授权、未做正式原分辨率终审，不得进入训练 |
...
1. 第二候选因训练后独立留出三变体7/5/6张误检被否决，第三候选因规范val30联合门失败被否决。第四候选通过冻结test100的full/core/stress部署512质量门，但其100张新独立留出在三变体中产生3/2/3张误检，已被正式拒绝。candidate4留出现已单调追加至保护registry v2，永久禁止训练。候选5已依据鱼饵反光件、椭圆家具五金和长椭圆发夹三类失败建立160项新训练候选计划；当前130/160，鱼饵、家具五金、发夹、凸面宝石、金属镶座、手工五金与非美甲化妆工具提示族已完成生成阶段初筛和机器门，仍缺30张，且未获商业训练精确授权。生成通过数不代表训练批准数。旧110图、145张训练清单和candidate4留出均不能替代新训练样本或下一候选的未见留出。同时仍缺用户典型失败案例、四类移动真机、至少100张Beta人工质量报告、生产ONNX与回滚证据。生产manifest、共享阈值和正式发布状态继续HOLD；
...
| 日期 | 版本 | 变更摘要 | 影响范围 |
| --- | --- | --- | --- |
| 2026-07-29 | v1.1.244 | candidate5第十三个非美甲化妆工具提示族121—130完成逐图独立生成和生成阶段可见初筛；首次图像接口网络错误未返回可验收结果，按相同约束重试。增量审计绑定120张前序快照，当前130/160通过、30缺失、0失败、0未知，items SHA-256为`aa2dba06…9eaf`，报告为`d6cc9cb2…5269`，下一缺口131。外层120秒超时后独立深验报告通过；全批继续训练禁止、授权缺失。正式完成度审计刷新为383标记/375 PASS、14门4通过/10 HOLD，报告`52af4a3b…2b16`；编码审计与差异检查结果同步至同日开发日志，素材保持Git外，代理未提交或推送Git | 候选5生成进度、非美甲工具边界、逐图质量初筛、保护集隔离、网络重试、审计超时复验、完成度审计、发布HOLD |
