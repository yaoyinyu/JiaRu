...
| 候选6正样本补强 | `record-positive-reinforcement-authorization.py`、`build-positive-reinforcement-annotation-workspace.py`及Git外`positive-reinforcement-annotation-workspace-v1` | 进行中（初审160/160；返修真值60张/275 mask） | 用户已对`requestedItemsSha256=1cdf2825…5bfe`的160张/76组/971枚可见甲面作精确商业训练授权，授权记录`67a17f2d…1b93`深验通过。8分片/80页首轮原分辨率审核为13张通过候选、147张返修、0排除。首批删误检返修终审4张/15 mask通过；第二批逐甲紧框仅1张/5 mask通过，两张透明低对比甲经人工多边形新增10 mask；后续27张人工/混合多边形新增124枚完整甲面，均通过polygon合法、同图零交叠、几何124/124及整图/逐甲2倍终审。另有`nail_00521…_1.jpg`因旧第5区域为白手套背景而哈希绑定为rework、未晋级。batch022完成`nail_00653…_3.jpg`返修但因已由真值018登记而不重复计数；batch023—043完成多类花纹/透明长甲、漏甲、误检清理、失焦止损、附着钻饰、遮挡补回、无效拓扑替换、侧视透明甲、法式/彩色长甲及整指/手链误标清退。batch044选择双手十甲清晰完整且来源组未占用的`nail_01150…_1.jpg`；保留6个完整旧polygon，删除吞入整段手指的右拇指候选、戒指假阳性和同甲重复大区域，补建右拇指、左右小指及带皮肤细尾的右手下方甲面共4个人工polygon。首轮第7枚仍有甲根皮肤细尾，保存在rejected迭代且不计数；重画后终版10/10 polygon合法、同图零交叠、几何10/10，整图及十组逐甲2倍确认每枚完整甲根、侧缘和甲尖，透明立体花饰保留在所属甲板内，无皮肤、戒指、桌面、衣物、阴影、文字、水印、重复或交叠污染。batch045选择来源组未占用的单手五枚透明/立体饰件甲`nail_00730…_1.jpg`；删除同甲重复候选，首轮5/5合法且零交叠但逐甲2倍仍拒绝三枚甲根皮肤尖尾及透明拇指大面积指腹污染。保留顶部金色饰件甲旧polygon并人工重画其余四甲后，终版5/5 polygon合法、同图零交叠、几何5/5，整图与五组逐甲2倍确认完整甲根、侧缘、甲尖和甲板内附着饰件，无皮肤、邻指、戒指、衣物、地面背景、文字、水印、重复或交叠污染；错误truth路径和非规范终结文件名两次失败证据均隔离保留且不计数。唯一训练真值索引现为60张/275 mask、0拒绝/冗余/冲突，权威与重放SHA-256均为`cb5ca372…f340`；索引仍明确`trainingUse=prohibited-until-materialization-audit`。正样本水印门和困难负样本水印消融门不变。其余100张尚未形成最终真值，完整来源隔离和训练物化尚未完成，禁止训练、val调参、冻结test推理、导出或部署 |
