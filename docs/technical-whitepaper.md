...
| 日期 | 版本 | 变更摘要 | 影响范围 |
| --- | --- | --- | --- |
| 2026-07-29 | v1.1.251 | 强化candidate5增量生成前序报告链：逐项重算计划身份、路径、状态、元数据、汇总、家族计数、下一缺口和决定，递归验证祖先SHA链、同一registry及已完成图片稳定性；篡改summary或promptId并重算items摘要均被拒绝。Python编译、专项6/6和真实20级链`9aa129a1…25c3`重放通过；candidate5继续等待精确授权且禁止训练 | 生成进度证据、防篡改、递归重放、candidate5训练HOLD |
