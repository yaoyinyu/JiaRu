...
| 训练真值当前权威快照 | 外部`training-truth-index-v1.json` | 进行中 | v1.1.170：87个批准报告归并为86张唯一图片/451个完整mask，1个冗余报告、0冲突，索引SHA-256为`300ef9ea7765e03fccbb7ef099e2126a7127a7be13e3e945d4b6ee84dce628a2`。批次062的`00722/00723/01118`新增3张/15 mask；两轮SAM多点返修仍吸收衣带、皮肤、玩偶绒毛或眼睛后切换原分辨率人工多边形，终版13个人工polygon与2个已审SAM polygon覆盖全部完整可见甲面，15/15 polygon合法、零交叠、几何全通过。最低100张train正样本完成86%、仍缺14张；val 0/30与约100张hard negative不变，整批物化和来源隔离前继续禁止训练。本行取代上方v1.1.169快照及数据集治理长行中的旧数量快照 |
