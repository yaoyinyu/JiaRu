...
| 数据集治理 | `model/datasets/nail-texture-v1` | 进行中 | 正式有效集为 400 图、2092 个 mask，split=293/45/62；第二批授权后累计导入 78 图（77 正样本、1 hard negative）和 507 个 mask，并按 deerplanet/more/other 集合隔离来源；剩余 35 张继续返修 |
