...
| 候选6正样本补强 | `record-positive-reinforcement-authorization.py`、`build-positive-reinforcement-annotation-workspace.py`及Git外`positive-reinforcement-annotation-workspace-v1` | 进行中（初审160/160；返修真值21张/80 mask） | 用户已对`requestedItemsSha256=1cdf2825…5bfe`的160张/76组/971枚可见甲面作精确商业训练授权，授权记录`67a17f2d…1b93`深验通过。8分片/80页首轮原分辨率审核为13张通过候选、147张返修、0排除。首批删误检返修终审4张/15 mask通过；第二批逐甲紧框仅1张/5 mask通过，随后两张透明低对比甲经人工多边形新增10 mask。下一批从剩余返修项中筛出`nail_00380…_2.jpg`：四枚粉色渐变甲以原分辨率人工polygon重建，4个polygon合法、零交叠、几何4/4，并通过整图与全部逐甲2倍源图/叠加裁片终审，新增4 mask。唯一训练真值索引现为21张/80 mask、0拒绝/冗余/冲突，SHA-256为`63c7a843…e05f`；索引仍明确`trainingUse=prohibited-until-materialization-audit`。其余返修、完整来源隔离和训练物化尚未完成，禁止训练、val调参、冻结test推理、导出或部署 |
