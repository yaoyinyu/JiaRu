...
| 候选6训练负样本 | `build-candidate6-hard-negative-generation-plan.py`、Git外`2026_7_31_candidate6_training_plan_v1`与`2026_7_31_candidate6_training_v1` | 进行中（10/160生成机器门） | 新计划从candidate5拒绝报告和registry v4深验提取5张误检、3个失败家族，只生成全新来源训练候选，不复制361—460。160项计划含16家族×10张，计划SHA-256为`136b5868…7b49`、items摘要`d49afd16…eecd`。首个`softgel_blister_single`家族001—010已逐图独立生成并做生成阶段可见初筛；增量审计报告`5d31cb40…4f30`确认10/10解码、最短边、命名、批内SHA/dHash和registry v4隔离通过，0失败、0未知，仍缺150张。该结果不等于正式原分辨率终审；全批继续`trainingUse=prohibited`、`authorizationStatus=missing`，未运行candidate5/6推理或训练 |
