  ...
  const record = createLocalNailDebugSample({
    ...
    detectionSummary: {
      ...
      partialCloseupDiagnostics: {
        ...
        strategy: "low-contrast-boundary",
        lowContrastComponentCount: 18,
        lowContrastAcceptedComponentCount: 5,
        lowContrastSelectedCandidateCount: 5,
        lowContrastRejectionCounts: { low_contrast_inside_too_dark: 2 },
      },
