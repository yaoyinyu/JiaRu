...
- candidate6 正样本商业训练授权清单共160张/预计971枚甲面；截至技术白皮书 v1.1.406，已有115张/608个完整甲面通过原分辨率终审，尚余45张/预计363枚甲面；batch103已晋升，batch104对透明低对比、交叠且水印叠主体的高风险源图止损排除，不计入真值。
...
- candidate6 正样本真值当前为115张/608 mask，剩余45张；完成整批训练物化审计前保持训练禁用
...
- [ ] candidate6完整甲面真值终审（当前115张/608 mask，剩余45张/预计363 mask）
