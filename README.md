...
- candidate7 已完成90张真实旧train图的原分辨率源图硬门：64张/524枚完整可见甲面进入完整mask重审，26张排除；与当前train120、val30、冻结test100图片哈希零重叠。机器审计发现133个无效polygon和28对同图交叠，旧polygon仅作定位线索。距新增不少于80张目标仍缺至少16张全新来源；完成完整mask终审及精确授权前，全批禁止训练。
...
- candidate7 已完成90/90源图硬门，保留64张/524枚完整可见甲面、排除26张；下一步重建64张完整mask并补足至少16张全新来源，尚未形成candidate7精确训练清单或启动授权
