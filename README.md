...
- candidate6 正样本商业训练授权清单共160张/预计971枚甲面；截至技术白皮书 v1.1.375，已有86张/435个完整甲面通过原分辨率终审，尚余74张/预计536枚甲面。
...
- candidate6 正样本真值当前为86张/435 mask，剩余74张；完成训练物化审计前保持训练禁用
...
- [ ] candidate6完整甲面真值终审（当前83张/420 mask，剩余77张/预计551 mask）
