...
- candidate6 GPU训练尚未启动，当前等待用户对上述精确输入、candidate3合规基座和固定训练参数授予本次启动授权；val30阈值校准、冻结test100推理和生产模型导出均未提前运行。
...
- candidate6 正样本真值当前为120张/636 mask；训练物化与独立输入深审已PASS，等待精确GPU训练启动授权
