...
- candidate6 正样本商业训练授权清单共160张/预计971枚甲面；截至技术白皮书 v1.1.387，已有98张/514个完整甲面通过原分辨率终审，尚余62张/预计457枚甲面。
...
- candidate6 正样本真值当前为98张/514 mask，剩余62张；完成训练物化审计前保持训练禁用
...
- [ ] candidate6完整甲面真值终审（当前98张/514 mask，剩余62张/预计457 mask）
