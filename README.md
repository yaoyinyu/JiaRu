...
- candidate24/25均已在val30否决：candidate24为128匹配/16漏检/27误检，candidate25最佳点仅与candidate21的128/16/19打平，均未运行冻结test100、未导出或部署。下一轮固定160项新来源训练困难负样本当前70/160，剩余90；项目standing商业授权会自动绑定精确清单，不再等待逐批确认，但正式原分辨率终审、角色隔离、终结和物化前仍禁止训练。
