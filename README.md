...
- candidate6 正样本商业训练授权清单共160张/预计971枚甲面；截至技术白皮书 v1.1.394，已有104张/548个完整甲面通过原分辨率终审，尚余56张/预计423枚甲面；batch092双手十甲已通过完整甲面终审与权威索引重放。
...
- candidate6 正样本真值当前为104张/548 mask，剩余56张；完成整批训练物化审计前保持训练禁用
...
- [ ] candidate6完整甲面真值终审（当前104张/548 mask，剩余56张/预计423 mask）
