...
- candidate6 正样本商业训练授权清单共160张/预计971枚甲面；截至技术白皮书 v1.1.382，已有93张/485个完整甲面通过原分辨率终审，尚余67张/预计486枚甲面。
...
- candidate6 正样本真值当前为93张/485 mask，剩余67张；完成训练物化审计前保持训练禁用
...
- [ ] candidate6完整甲面真值终审（当前93张/485 mask，剩余67张/预计486 mask）
