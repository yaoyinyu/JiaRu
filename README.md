...
- candidate6 正样本商业训练授权清单共160张/预计971枚甲面；截至技术白皮书 v1.1.396，已有106张/563个完整甲面通过原分辨率终审，尚余54张/预计408枚甲面；batch094透明低对比五甲已通过完整甲面终审与权威索引重放。
...
- candidate6 正样本真值当前为106张/563 mask，剩余54张；完成整批训练物化审计前保持训练禁用
...
- [ ] candidate6完整甲面真值终审（当前106张/563 mask，剩余54张/预计408 mask）
