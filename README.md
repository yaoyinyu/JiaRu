...
| 文档 | 说明 |
| --- | --- |
| [技术白皮书](docs/technical-whitepaper.md) v1.1.675 | 模块状态、接口契约、使用方式、已知限制——项目唯一总入口 |
...
- [ ] 循环016 v2 重建：单次 SAM 止损分流后 36 枚接受、21 枚转人工，完成剩余 21 枚人工 polygon 并重建预计 278 实例/18 来源组的 v2 真值；v2 通过前禁止训练与阈值校准
