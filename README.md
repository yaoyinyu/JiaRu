...
- candidate6 正样本商业训练授权清单共160张/预计971枚甲面；截至技术白皮书 v1.1.392，已有103张/538个完整甲面通过原分辨率终审，尚余57张/预计433枚甲面。
...
- candidate6 正样本真值当前为103张/538 mask，剩余57张；完成整批训练物化审计前保持训练禁用
...
- [ ] candidate6完整甲面真值终审（当前103张/538 mask，剩余57张/预计433 mask）
