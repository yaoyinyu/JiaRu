...
- candidate6 正样本商业训练授权清单共160张/预计971枚甲面；截至技术白皮书 v1.1.390，已有101张/528个完整甲面通过原分辨率终审，尚余59张/预计443枚甲面。
...
- candidate6 正样本真值当前为101张/528 mask，剩余59张；完成整批训练物化审计前保持训练禁用
...
- [ ] candidate6完整甲面真值终审（当前101张/528 mask，剩余59张/预计443 mask）
