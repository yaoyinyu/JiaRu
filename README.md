...
- candidate7 已形成60张/387个严格完整甲面真值（旧真实33张/237 mask、新正样本27张/150 mask），与当前train120、val30、冻结test100保持图片身份隔离；未通过原分辨率完整甲面门或存在应见甲数冲突的返修项均不计数。距新增不少于80张目标按严格真值仍缺20张；完成剩余返修、精确授权与物化审计前，全批禁止训练。
...
- candidate7 当前严格真值为60张/387 mask；下一步至少再形成20张严格真值并完成精确训练清单、授权和物化输入审计
