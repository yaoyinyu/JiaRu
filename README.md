...
| AI 美甲生图 | `/ai-generate` | ✅ | 文字描述 + 10 种风格提示词库（各 50 段） → Agnes Image 2.1 Flash 生成；用户已完成真实功能验收 |
...
| 文档 | 说明 |
| --- | --- |
| [技术白皮书](docs/technical-whitepaper.md) v1.1.364 | 模块状态、接口契约、使用方式、已知限制——项目唯一总入口 |
