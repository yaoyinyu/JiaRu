...
完整说明见 [`/privacy`](http://localhost:3000/privacy)（最后更新 2026-08-15）。AI 生图会把你的文字描述转发给第三方图像生成服务（Agnes AI），生成结果由浏览器直接访问第三方图片地址；描述中请勿输入身份证号、电话等个人信息。项目不使用 Cookie 追踪、无广告追踪、无账户体系，联系邮箱 `3181484805@qq.com`。
