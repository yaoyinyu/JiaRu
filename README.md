...
- candidate6 正样本商业训练授权清单共160张/预计971枚甲面；截至技术白皮书 v1.1.399，已有109张/578个完整甲面通过原分辨率终审，尚余51张/预计393枚甲面；batch097裸色/金色蝴蝶长甲五甲已通过完整甲面终审与权威索引重放。
...
- candidate6 正样本真值当前为109张/578 mask，剩余51张；完成整批训练物化审计前保持训练禁用
...
- [ ] candidate6完整甲面真值终审（当前109张/578 mask，剩余51张/预计393 mask）
