...
- candidate6 正样本商业训练授权清单共160张/预计971枚甲面；截至技术白皮书 v1.1.368，已有80张/405个完整甲面通过原分辨率终审，尚余80张/预计566枚甲面。
...
| 文档 | 说明 |
| --- | --- |
| [技术白皮书](docs/technical-whitepaper.md) v1.1.368 | 模块状态、接口契约、使用方式、已知限制——项目唯一总入口 |
