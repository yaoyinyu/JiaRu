...
- candidate24：独立train角色真值扩充进行中。`00251…_10`五甲与`00415…_5`十甲经原分辨率人工多边形成功修复（后者九甲中间版因漏甲被视觉门否决），补强真值v29为57张/394 mask、旧56张稳定身份零漂移；当前不以2张/15 mask小批增量开训，继续扩充后再物化，产品保持HOLD。
