...
- candidate6 正样本商业训练授权清单共160张/预计971枚甲面；截至技术白皮书 v1.1.371，已有82张/415个完整甲面通过原分辨率终审，尚余78张/预计556枚甲面。
...
- candidate6 正样本真值当前为82张/415 mask，剩余78张；完成训练物化审计前保持训练禁用
...
| 文档 | 说明 |
| --- | --- |
| [技术白皮书](docs/technical-whitepaper.md) v1.1.371 | 模块状态、接口契约、使用方式、已知限制——项目唯一总入口 |
...
- [ ] candidate6完整甲面真值终审（当前82张/415 mask，剩余78张/预计556 mask）
