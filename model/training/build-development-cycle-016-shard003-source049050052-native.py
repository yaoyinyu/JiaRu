...
TARGETS = (49, 50, 52)
EXPECTED_NAILS = {49: 5, 50: 5, 52: 4}
EXPECTED_CANONICAL = {49: 1, 50: 1, 52: 0}
...
def verify_images(report: dict) -> None:
    if report["counts"] != {"sourceImages": 3, "oldLabelNails": 14, "visualApprovals": 0}:
...
def build(shard_path: Path, triage_path: Path, output: Path) -> dict:
    ...
    for ordinal in TARGETS:
        ...
        if (len(historical) != EXPECTED_CANONICAL[ordinal] or
    ...
    report = {"schemaVersion": 1, "ok": True,
              ...
              "counts": {"sourceImages": 3, "oldLabelNails": 14, "visualApprovals": 0},
              "sources": records,
