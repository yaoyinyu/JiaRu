#!/usr/bin/env python3
"""Bind and render the frozen old polygons for shard002 sources 30 and 40."""
...
def main() -> None:
    ...
    if args.verify_report:
        ...
        current = build(Path(old["inputs"]["shardReport"]["path"]),
                        ...
                        Path(old["inputs"]["progressV11"]["path"]),
