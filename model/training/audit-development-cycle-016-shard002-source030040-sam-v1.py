#!/usr/bin/env python3
"""Bind SAM candidate topology and untinted review crops for sources 30/40."""
...
def build(prompt_path: Path, sam_path: Path, geometry_path: Path,
    ...
    return {"schemaVersion": 1, "ok": True,
            "decision": "source030040_sam_geometry_pass_visual_review_pending",
