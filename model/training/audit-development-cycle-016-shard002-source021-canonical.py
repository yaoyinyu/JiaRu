#!/usr/bin/env python3
"""Prove source21's historical approved truth equals its defective cycle012 label."""
...
def build(index_path: Path, shard_path: Path, progress_path: Path) -> dict:
    ...
    return {"schemaVersion": 1, "ok": True,
            ...
            "sourceOrdinal": 21, "sourceFileName": TARGET,
            "inputs": {"sourceScript": bind(Path(__file__)), "canonicalIndex": bind(index_path),
                       ...
                       "shardReport": bind(shard_path), "progressV5": bind(progress_path),
