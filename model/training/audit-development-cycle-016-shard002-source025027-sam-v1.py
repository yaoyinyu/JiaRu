#!/usr/bin/env python3
"""Bind SAM candidate topology and untinted review crops for sources 25/27."""
...
def build(prompt_path: Path, sam_path: Path, geometry_path: Path,
    ...
    if (prompts["decision"] != "source025027_one_directed_sam_pass_candidate_only" or
            ...
            old["decision"] !=
            "source025027_old_polygon_original_resolution_review_pending"):
        raise ValueError("source025027 SAM input/geometry contract mismatch")
    ...
    return {"schemaVersion": 1, "ok": True,
            "decision": "source025027_sam_geometry_pass_visual_review_pending",
