#!/usr/bin/env python3
"""One directed SAM candidate pass for four failed complete-nail polygons."""
...
PROMPTS = {
    30: [
        (3, [421, 776, 553, 938],
         [[448, 908], [484, 868], [507, 830]],
         [[558, 820], [565, 868], [425, 772]]),
        (5, [135, 638, 366, 765],
         [[181, 679], [257, 702], [343, 731]],
         [[194, 625], [355, 782], [374, 700]]),
    ],
    40: [
        (3, [602, 752, 725, 966],
         [[633, 785], [658, 854], [684, 923]],
         [[732, 780], [735, 918], [702, 978]]),
        (5, [644, 65, 742, 194],
         [[680, 92], [687, 131], [693, 167]],
         [[682, 213], [751, 147], [633, 156]]),
    ],
}
...
def build(old_outline_path: Path, preflight_path: Path) -> dict:
    ...
    if (outline["decision"] !=
            "source030040_old_polygon_original_resolution_review_pending" or
            outline["trainingUse"] != "prohibited" or
            preflight["counts"]["historicalCanonicalRecords"] != 1 or
            [r["ordinal"] for r in outline["sources"]] != [30, 40]):
    ...
    return {"schemaVersion": 1,
            "decision": "source030040_one_directed_sam_pass_candidate_only",
