...
MANUAL_N4 = [
    ...
    (649, 428), (628, 425), (611, 426), (598, 425), (592, 420),
    (590, 412), (592, 403), (599, 393), (611, 384), (627, 378),
    (643, 371), (662, 364),
    (684, 358), (705, 354), (724, 352),
]
QA_N4 = {
    "positive": [(595, 414), (610, 399), (650, 395), (729, 379)],
    "negative": [(585, 416), (625, 362), (660, 348), (600, 374), (650, 442)],
}
MANUAL_INDICES = {1, 4}
...
def build(native_path: Path, progress_path: Path, first_visual_path: Path,
    ...
    annotation = {
        "version": "shard003-source059-historical-correction-candidate/v3",
